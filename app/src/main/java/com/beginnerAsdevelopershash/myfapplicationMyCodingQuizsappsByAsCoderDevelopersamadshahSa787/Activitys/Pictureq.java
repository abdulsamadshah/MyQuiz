...
import com.beginnerAsdevelopershash.myfapplicationMyCodingQuizsappsByAsCoderDevelopersamadshahSa787.databinding.ActivityPictureqBinding;
...
public class Pictureq extends AppCompatActivity {


    ActivityPictureqBinding binding;
    String userid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPictureqBinding.inflate(getLayoutInflater());
    ...
    private void categoriesdatashowrecyclerview() {
        ...
        categoriesdata.collection("Picturecategory")
        ...
        binding.picturerv.setLayoutManager(new GridLayoutManager(getApplicationContext(), 2));
        binding.picturerv.setAdapter(adapter);
    ...
    private void windowtoptollbar() {
        setSupportActionBar(binding.picturetb);
        if (Build.VERSION.SDK_INT >= 21) {
            Window window = Pictureq.this.getWindow();
