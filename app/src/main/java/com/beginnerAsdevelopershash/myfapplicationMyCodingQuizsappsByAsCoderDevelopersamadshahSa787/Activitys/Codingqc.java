...
import com.beginnerAsdevelopershash.myfapplicationMyCodingQuizsappsByAsCoderDevelopersamadshahSa787.databinding.ActivityCodingqcBinding;
...
public class Codingqc extends AppCompatActivity {

    ActivityCodingqcBinding binding;
    String userid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCodingqcBinding.inflate(getLayoutInflater());
    ...
    private void categoriesdatashowrecyclerview() {
        ...
        binding.categoryrv.setLayoutManager(new GridLayoutManager(getApplicationContext(), 2));
    ...
    private void windowtoptollbar() {
        setSupportActionBar(binding.codingqtb);
        if (Build.VERSION.SDK_INT >= 21) {
            Window window = Codingqc.this.getWindow();
