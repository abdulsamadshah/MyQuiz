...
import com.beginnerAsdevelopershash.myfapplicationMyCodingQuizsappsByAsCoderDevelopersamadshahSa787.databinding.ActivityGkquizcBinding;
...
public class Gkquizc extends AppCompatActivity {


    ActivityGkquizcBinding binding;
    String userid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGkquizcBinding.inflate(getLayoutInflater());
    ...
    private void categoriesdatashowrecyclerview() {
        ...
        categoriesdata.collection("Gkcategory")
        ...
        binding.gkrv.setLayoutManager(new GridLayoutManager(getApplicationContext(), 2));
        binding.gkrv.setAdapter(adapter);
    ...
    private void windowtoptollbar() {
        setSupportActionBar(binding.gkqtb);
        if (Build.VERSION.SDK_INT >= 21) {
            Window window = Gkquizc.this.getWindow();
