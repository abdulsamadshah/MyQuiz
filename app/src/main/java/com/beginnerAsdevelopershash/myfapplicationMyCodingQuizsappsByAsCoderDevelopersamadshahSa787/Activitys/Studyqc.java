...
import com.beginnerAsdevelopershash.myfapplicationMyCodingQuizsappsByAsCoderDevelopersamadshahSa787.databinding.ActivityStudyqcBinding;
...
public class Studyqc extends AppCompatActivity {


    ActivityStudyqcBinding binding;
    String userid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityStudyqcBinding.inflate(getLayoutInflater());
    ...
    private void categoriesdatashowrecyclerview() {
        ...
        categoriesdata.collection("studycategory")
        ...
        binding.studyrv.setLayoutManager(new GridLayoutManager(getApplicationContext(), 2));
        binding.studyrv.setAdapter(adapter);
    ...
    private void windowtoptollbar() {
        setSupportActionBar(binding.studyqtb);
        if (Build.VERSION.SDK_INT >= 21) {
            Window window = Studyqc.this.getWindow();
